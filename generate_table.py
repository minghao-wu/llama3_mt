...
for z, f, zi, fi in zip(zero_base, five_base, zero_instruct, five_instruct):
    ...
    lines.append([z["src_lang"], round(z["score"], 2), round(f["score"], 2), round(zi["score"], 2), zi_rate, round(fi["score"], 2), fi_rate])
writer = MarkdownTableWriter(
    table_name="8B Model X-English",
    headers=["languages", "0-shot Base", "5-shot Base", "0-shot Instruct", "0-shot Pass@1", "5-shot Instruct", "5-shot Pass@1"],
    value_matrix=lines,
)
